...
namespace easy2code_game.Modes
{
    public class Level1 : AbstractGameDesign
    {
        ...
        private Block exit_button, hint_button, start_button, static_element, var_block1, var_block2, var_block3, loop_block, if_block;
        ...
        public override void LoadContent(ContentManager Content)
        {
            ...
            if_block.setRectangle(new Rectangle(3, 430, if_block.texture.Width, if_block.texture.Height));
