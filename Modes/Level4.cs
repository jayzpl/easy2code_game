...
{
    public class Level4 : AbstractGameDesign
    {
        private List<Block> blocks = new List<Block>();
        private List<Block> buttons = new List<Block>();
        private List<Block> elements = new List<Block>();

        private Block exit_button, hint_button, start_button, static_element, var_block1, var_block2, var_block3, var_block4, loop_block, loop_block2;
        ...
        private string task = "Dowolne"; //here is the task result of this level 
        ...
        public override void LoadContent(ContentManager Content)
        {
            ...
            loop_block2.setRectangle(new Rectangle(3, 530, loop_block.texture.Width, loop_block.texture.Height));
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if(ms_current.LeftButton == ButtonState.Pressed && ms_rect.Intersects(hint_button.rect) && ms_old.LeftButton == ButtonState.Released){ //Hint
                Data.displayText1 = Data.lvl4Text1;
                Data.displayText2 = Data.lvl4Text2;
